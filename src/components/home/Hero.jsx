  ...
  return (
    <div className="relative w-full h-[60vh] md:h-[90vh] rounded-2xl overflow-hidden p-4">
      <div className="relative w-full h-full">
        ...
        <div className="absolute inset-0 z-10 bg-gradient-to-r from-[rgba(26,26,26,0.56)] via-[rgba(75,75,75,0.44)] to-[rgba(26,26,26,0.56)] rounded-2xl flex flex-col justify-center items-center sm:items-start text-center sm:text-left px-6 sm:px-16 md:px-24 transition-all duration-300">
