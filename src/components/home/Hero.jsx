...
const Hero = () => {
  return (
    <div className="relative w-full rounded-2xl overflow-hidden p-4">
      <div className="relative w-full">
        <img
          src="/img/Hero.png"
          alt="Hero"
          className="w-full h-auto max-h-[90vh] object-cover object-center rounded-2xl transition-all duration-500"
        />
