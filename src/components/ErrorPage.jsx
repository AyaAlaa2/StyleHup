...
const ErrorPage = () => {
  return (
    <div className="flex flex-col items-center justify-start px-[16px] h-[495px]">
      ...
      <div className="py-[12px] w-[80%]">
        <label className="input flex bg-[#F2F2F2] border-[#F2F2F2] items-center justify-center px-[16px]">
      ...
      <div className="flex items-center justify-center px-[12px] gap-[12px] pt-[12px]">
        <button className="px-[48px] py-[9.5px] bg-black text-white rounded-lg font-bold text-[14px] leading-[21px]">
          Go To Homepage
        </button>
        <button className="px-[48px] py-[9.5px] bg-[#F2F2F2] text-black rounded-lg font-bold text-[14px] leading-[21px]">
          Browse Categories
        </button>
      </div>
    </div>
